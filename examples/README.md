...
| [`holo/`](holo/) | Holo-3.1 / Qwen3.5-VL GUI-agent VLM: vision tower + **hybrid gated-delta-net decoder** (`t2n_extra::gated_delta_scan`) joint export, single-binary Rust+tract demo threading conv + recurrent + KV state across the generation loop | (no tutorial yet) |: |
| [`nuextract3/`](nuextract3/) | NuExtract3 / Qwen3.5-VL document VLM: image-to-Markdown export with the hybrid gated-delta-net decoder and a minimal Rust+tract runner that decodes generated Markdown | (no tutorial yet) |: |
