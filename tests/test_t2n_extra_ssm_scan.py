"""Round-trip test for the `t2n_extra::ssm_scan` custom op.

Verifies that a tiny module wrapping `torch.ops.t2n_extra.ssm_scan`
exports to NNEF, optimizes through tract's declutter (incl. the scan
body in `tract_core_scan`), and matches PyTorch numerically.
"""
...
class _ScanOnly(torch.nn.Module):
