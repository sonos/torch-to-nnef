...
- **`t2n_extra::gated_delta_scan`** (core): a `tract_core_scan`-backed op for the gated-delta-net (delta-rule, gated matrix-state) linear-attention recurrence, sibling of the Mamba `ssm_scan` op.
