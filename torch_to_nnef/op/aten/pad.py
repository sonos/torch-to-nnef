...
def reflection_padnd(
    ...
    """ Operator mapping PyTorch: 'aten:reflection_pad1d', 'aten:reflection_pad2d', 'aten:reflection_pad3d', 'aten:reflection_padnd' to NNEF """
...
def replication_padnd(
    ...
    """ Operator mapping PyTorch: 'aten:replication_pad1d', 'aten:replication_pad2d', 'aten:replication_pad3d', 'aten:replication_padnd' to NNEF """
    (input_node, pads_node) = node.inputs
    pads = _pad_format(
        get_list_of_int(
            pads_node,
...
def constant_pad_nd(
    ...
    """ Operator mapping PyTorch: 'aten:constant_pad1d', 'aten:constant_pad_nd' to NNEF """
