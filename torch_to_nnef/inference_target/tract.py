...
class TractNNEF(InferenceTarget):
    ...
    def __init__(
        ...
        Args:
            ...
            force_attention_inner_in_f32: control if attention should be forced as f32 inside (even if inputs are all f16), usefull for unstable networks like qwen2.5
