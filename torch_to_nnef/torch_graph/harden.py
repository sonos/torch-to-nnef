...
def harden_jit_for_export(
    ...
    **Specialize for the example inputs** (always, in this order):
    ...
    4. `fold_tuple_index_through_tuple_construct`: collapse the
       `TupleConstruct -> TupleIndex` round-trip.
    ...
    n_tuple = fold_tuple_index_through_tuple_construct(graph)
    ...
    if diag is not None:
        ...
        diag["fold_tuple_index_through_tuple_construct"] = n_tuple
