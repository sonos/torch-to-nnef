...
# <picture><source media="(prefers-color-scheme: dark)" srcset="./docs/img/torch_to_nnef.png"><source media="(prefers-color-scheme: light)" srcset="./docs/img/torch_to_nnef_black.png"><img alt="Torch to NNEF" src="./docs/img/torch_to_nnef_black.png"></picture>
...
Export PyTorch models in a way that is auditable, debuggable, and stable across runtimes
...
Torch-to-NNEF converts PyTorch models and tensors into NNEF, a simple and explicit neural network exchange format designed for reliable inference and long-term maintainability.
